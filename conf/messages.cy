service.name=Llinellau Cymorth CThEF
title.suffix=- Llinellau Cymorth CThEF - GOV.UK
error.prefix=Gwall
back=Yn ôl
...
call-option.label.contact-hmnrc=Rhywbeth arall

default.title=Ffoniwch linell gymorth CThEF
default.need-help.heading=Os oes angen help arnoch i fewngofnodi
default.need-help.p1=Os oes angen help arnoch i adfer eich dynodydd defnyddiwr (ID), ailosod eich cyfrinair neu newid sut rydych yn cael eich codau cyrchu, mae angen i chi gysylltu â Gwasanaeth Cwsmeriaid Cymraeg CThEF drwy ffonio <span class="govuk-!-font-weight-bold no-wrap">0300 200 1900</span>.
default.need-help.p2=Mae ffyrdd eraill o <a class="govuk-link" href="{0}">gysylltu â Gwasanaeth Cwsmeriaid Cymraeg CThEF</a>.
...
childcare-service.query.headingNew=Ffoniwch Wasanaeth Cwsmeriaid Cymraeg CThEF ar gyfer ymholiadau ynghylch y gwasanaeth Gofal Plant
childcare-service.query.contact_number.telephone.text=Ffôn:
childcare-service.query.contact_number.telephone.number=0300 200 1900
childcare-service.query.contact_number.textphone.text=Ffôn testun:
...
income-tax-paye.query.p2=Mae ffyrdd eraill o <a class="govuk-link" href="{0}">gysylltu â Gwasanaeth Cwsmeriaid Cymraeg CThEF</a>.

income-tax-paye.query.headingNew=Ffoniwch Wasanaeth Cwsmeriaid Cymraeg CThEF ar gyfer ymholiadau ynghylch Treth Incwm a TWE
income-tax-paye.query.contact_number.telephone.text=Ffôn:
income-tax-paye.query.contact_number.telephone.number=0300 200 1900
income-tax-paye.query.contact_number.no_uk_telephone.text=Y tu allan i’r DU:
...
national-insurance.query.p2=Mae ffyrdd eraill o <a class="govuk-link" href="{0}">gysylltu â Gwasanaeth Cwsmeriaid Cymraeg CThEF</a>.

national-insurance.query.headingNew=Ffoniwch Wasanaeth Cwsmeriaid Cymraeg CThEF ar gyfer ymholiadau ynghylch Yswiriant Gwladol
national-insurance.query.contact_number.telephone.text=Ffôn:
national-insurance.query.contact_number.telephone.number=0300 200 1900
national-insurance.query.contact_number.no_uk_telephone.text=Y tu allan i’r DU:
...
machine-games-duty.query.p2=Gallwch <a class="govuk-link" href="{0}">ddod o hyd i ffyrdd eraill o gysylltu â ni am Tholl Peiriannau Hapchwarae</a>.

machine-games-duty.query.headingNew=Ffoniwch Wasanaeth Cwsmeriaid Cymraeg CThEF i drafod Toll Peiriannau Hapchwarae
machine-games-duty.query.contact_number.telephone.text=Ffôn:
machine-games-duty.query.contact_number.telephone.number=0300 200 3705
machine-games-duty.query.contact_number.no_uk_telephone.text=Y tu allan i’r DU:
...
online-services.need-help.p1=I gael help i adfer eich manylion mewngofnodi negit stu newid sut rydych yn cael eich codau cyrchu, mae angen i chi gysylltu â Gwasanaeth Cwsmeriaid Cymraeg CThEF drwy ffonio <span class="govuk-!-font-weight-bold no-wrap">0300 200 1900</span>.
online-services.need-help.p2=Gallwch <a class="govuk-link" href="{0}">ddod o hyd i ffyrdd eraill o gysylltu â Gwasanaeth Cwsmeriaid Cymraeg CThEF</a>.

paye-for-employers.query.heading=Help gyda TWE
...
state-pension.query.p2=Mae ffyrdd eraill o <a class="govuk-link" href="{0}">gysylltu â Gwasanaeth Cwsmeriaid Cymraeg CThEF</a>.

state-pension.query.headingNew=Ffoniwch Wasanaeth Cwsmeriaid Cymraeg CThEF ar gyfer ymholiadau ynghylch Pensiwn y Wladwriaeth
state-pension.query.contact_number.telephone.text=Ffôn:
...
tax-credits.query.p2=Mae ffyrdd eraill o <a class="govuk-link" href="{0}">gysylltu â Gwasanaeth Cwsmeriaid Cymraeg CThEF</a>.

tax-credits.query.headingNew=Ffoniwch Wasanaeth Cwsmeriaid Cymraeg CThEF ar gyfer ymholiadau ynghylch credydau treth
tax-credits.query.contact_number.telephone.text=Ffôn:
tax-credits.query.contact_number.telephone.number=0300 200 1900
tax-credits.query.contact_number.no_uk_telephone.text=Y tu allan i’r DU:
...
vat.query.p2=Gallwch <a class="govuk-link" href="{0}">ddod o hyd i ffyrdd eraill o gysylltu â ni am TAW</a>.

vat.query.headingNew=Ffoniwch y llinell gymorth Gymraeg ar gyfer Ymholiadau TAW
vat.query.contact_number.telephone.text=Ffôn:
vat.query.contact_number.telephone.number=0300 200 3705
vat.query.contact_number.no_uk_telephone.text=Y tu allan i’r DU:
...
general-enquiries.query.heading=Help gyda gwasanaeth
general-enquiries.query.p1=Os nad oes angen help arnoch i fewngofnodi, ond bod gennych ymholiad am rywbeth arall, gallwch gysylltu â Gwasanaeth Cwsmeriaid Cymraeg CThEF drwy ffonio <span class="govuk-!-font-weight-bold no-wrap">0300 200 1900</span>.
general-enquiries.query.p2=Mae ffyrdd eraill o <a class="govuk-link" href="{0}">gysylltu â Gwasanaeth Cwsmeriaid Cymraeg CThEF</a>.
...
contact_us.died.call_hmrc=Ffoniwch CThEF am help gyda threth ar ôl i rywun farw.
contact_us.died.call_advice=Mae’r llinell gymorth hon yn defnyddio meddalwedd adnabod lleferydd, felly gofynnir i chi pam eich bod yn ffonio CThEF. Gwnewch eich gorau i ateb gan ddefnyddio brawddegau a geiriau byr, er enghraifft:
...
contact_us.died.getHelp=Help i <a href="{0}" class="govuk-link"> ddelio â CThEF os oes gennych anghenion ychwanegol</a>
contact_us.died.callCharges=<a href="{0}" class="govuk-link">Gwybodaeth am gostau galwadau</a>

find-HMRC-helplines.h1=Dod o hyd i un o linellau cymorth CThEF
...
helpline.service.advance-ruling-service=Gwasanaeth Dyfarniadau Uwch
helpline.service.advance-tariff-ruling=Dyfarniad Tariffau Ymlaen Llaw
helpline.service.aggregate-levy=Ardoll Agregau
helpline.service.air-passenger-duty=Toll Teithwyr Awyr
helpline.service.alcohol-and-tobacco-warehousing-declarations=Datganiadau Warysu Alcohol a Thybaco
helpline.service.alcoholic-ingredients-relief=Rhyddhad Cynhwysion Alcoholaidd
helpline.service.alcohol-wholesaler-registration-scheme=Cynllun Cofrestru Cyfanwerthwyr Alcohol
helpline.service.annual-tax-on-enveloped-dwellings=Treth Flynyddol ar Anheddau wedi’u Hamgáu
helpline.service.money-laundering=Gwyngalchu Arian
helpline.service.automatic-exchange-of-information=Cyfnewid Gwybodaeth yn Awtomatig
helpline.service.bingo-duty=Toll Bingo
helpline.service.biodiesel-and-fuels-production-duty=Toll Cynhyrchu Biodiesel a Thanwyddau
helpline.service.capital-gains-tax=Treth Enillion Cyfalaf
helpline.service.change-vat-registration-details=Newid manylion cofrestru TAW
helpline.service.charities-and-community-amateur-sports-clubs=Elusennau a Chlybiau Chwaraeon Amatur Cymunedol
helpline.service.child-trust-fund=Cronfa Ymddiriedolaeth Plant
helpline.service.claims-for-refund-of-vat-by-certain-bodies=Hawliadau am Ad-daliad TAW gan Gyrff Penodol
helpline.service.construction-industry-scheme-cis=Cynllun y Diwydiant Adeiladu (CIS)
helpline.service.corporation-tax=Treth Gorfforaeth
helpline.service.country-by-country-reporting=Cyflwyno adroddiadau Gwlad wrth wlad
helpline.service.cross-border-arrangement=Trefniant ar draws y ffin
helpline.service.customs-declaration-service=Gwasanaeth Datganiadau Tollau
helpline.service.customs-trader-services-cts=Gwasanaethau Masnachwyr Tollau (CTS)
helpline.service.digital-services-tax-dst=Treth Gwasanaethau Digidol (DST)
helpline.service.duty-deferment-electronic-statements=Datganiadau Electronig i Ohirio Tollau
helpline.service.electronic-binding-tariff-information=Gwybodaeth Electronig am Dariff sy’n Rhwymo
helpline.service.excise-movement-and-control-system=System Symudiadau a Rheolaeth Ecséis
helpline.service.fuels-duty=Toll Tanwyddau
helpline.service.fulfilment-house-due-diligence-scheme=Cynllun Diwydrwydd Dyladwy ar gyfer Busnesau Cyflawni
helpline.service.gaming-duty=Toll Hapchwarae
helpline.service.gas-for-use-as-road-fuel-duty=Toll ar Nwy i’w ddefnyddio fel Tanwydd Ffordd
helpline.service.general-betting-duty=Toll Fetio Gyffredinol
helpline.service.goods-vehicle-movement-service=Gwasanaeth Symud Cerbydau Nwyddau
helpline.service.import-control-system-ics=System Rheoli Mewnforion (ICS)
helpline.service.insurance-premium-tax=Treth Premiwm Yswiriant
helpline.service.landfill-tax=Treth Dirlenwi
helpline.service.lifetime-isa=ISA gydol oes
helpline.service.lottery-duty=Toll y Loteri
helpline.service.machine-games-duty=Toll Peiriannau Hapchwarae
helpline.service.making-tax-digital-for-income-tax=Troi Treth yn Ddigidol ar gyfer Treth Incwm
helpline.service.making-tax-digital-for-vat=Troi Treth yn Ddigidol ar gyfer TAW
helpline.service.new-computerised-transit-system=System Gludo Gyfrifiadurol Newydd
helpline.service.new-export-system-nes=System Allforio Newydd (NES)
helpline.service.non-taxable-trust-registration=Cofrestriadau ar gyfer ymddiriedolaethau nad ydynt yn drethadwy
helpline.service.notification-of-vehicle-arrivals-nova=Hysbysiad o Gerbydau’n Cyrraedd (NOVA)
helpline.service.other-business-taxes-duties-and-schemes=Trethi, tollau a chynlluniau busnes eraill
helpline.service.paye-for-employers=TWE i gyflogwyr
helpline.service.pension-schemes-online-service=Gwasanaethau Cynlluniau Pensiwn ar-lein
helpline.service.pension-schemes-for-administrators=Cynlluniau Pensiwn ar gyfer Gweinyddwyr
helpline.service.pension-schemes-for-practitioners=Cynlluniau Pensiwn ar gyfer Ymarferwyr
helpline.service.plastic-packaging-tax=Treth Deunydd Pacio Plastig
helpline.service.pool-betting-duty=Toll Cronfa Fetio
helpline.service.qualifying-recognised-overseas-pension-scheme-qrops=Cynlluniau Pensiwn Tramor Cydnabyddedig Cymwys (QROPS)
helpline.service.rebated-oils-enquiry-service=Gwasanaeth Ymholiadau Olew Ad-daledig
helpline.service.remote-gambling-duty=Toll Hapchwarae o Bell
helpline.service.report-and-pay-import-vat-ni=Rhoi gwybod am a thalu TAW mewnforio (Gogledd Iwerddon)
helpline.service.report-and-pay-import-vat-tsp=Rhoi gwybod am a thalu TAW mewnforio (TSP)
helpline.service.safety-and-security=Diogelwch
helpline.service.self-assessment=Hunanasesiad
helpline.service.self-assessment-online-for-partnerships=Hunanasesiad Ar-lein ar gyfer Partneriaethau
helpline.service.self-assessment-online-for-trusts=Hunanasesiad Ar-lein ar gyfer Ymddiriedolaethau
helpline.service.secure-electronic-transfer-set=Trosglwyddiad Electronig Diogel (SET)
helpline.service.shared-workspace=Gweithle sy’n cael ei Rannu
helpline.service.soft-drinks-industry-levy=Ardoll y Diwydiant Diodydd Ysgafn
helpline.service.stamp-duty-land-tax-for-organisations=Treth Dir y Tollau Stamp ar gyfer Sefydliadau
helpline.service.employment-intermediary-report=Adroddiad cyfryngwr cyflogaeth
helpline.service.vat-returns=Ffurflenni TAW
helpline.service.tailored-support-programme=Rhaglen rhoi cymorth wedi’i deilwra
helpline.service.imports-from-ireland=Mewnforion o Iwerddon
helpline.service.tied-oils-enquiry-service=Gwasanaeth Ymholiadau Olew ‘Tied’
helpline.service.trust-registration-service=Y Gwasanaeth Cofrestru Ymddiriedolaethau
helpline.service.vat-ec-sales-list-ecsl=TAW: Rhestr Gwerthiannau yn y GE (ECSL)
helpline.service.vat-eu-refunds=Ad-daliadau TAW yr UE
helpline.service.vat-for-government-and-nhs=TAW ar gyfer y Llywodraeth a’r GIG
helpline.service.vat-mini-one-stop---shop-for-businesses-based-in-the-uk-and-eu=Gwasanaeth Mini Un Cam ar gyfer TAW – i fusnesau wedi’u lleoli yn y DU a’r UE
helpline.service.vat-mini-one-stop---shop-for-businesses-based-outside-the-uk-and-eu=Gwasanaeth Mini Un Cam ar Gyfer TAW – ar gyfer busnesau nad ydynt wedi’u lleoli yn y DU a’r UE
helpline.service.vat-reverse-charge-sales-list-rcsl=Rhestr Gwerthiannau Tâl Gwrthdro TAW (RCSL)
helpline.service.voa-check-and-challenge-your-business-rates-valuation=Gwirio a herio’ch prisiad trethi busnes gan y VOA
helpline.service.tax-code-change=Newid i’r cod treth
helpline.service.help-to-save=Cymorth i Gynilo
helpline.service.child-benefit=Budd-dal Plant
...
helplines-search.money-laundering=Cysylltwch â’r llinell gymorth Gymraeg ar gyfer Ymholiadau TAW, Tollau ac Ecséis i adfer eich manylion mewngofnodi ar gyfer cofrestriad gwrth-wyngalchu arian.
