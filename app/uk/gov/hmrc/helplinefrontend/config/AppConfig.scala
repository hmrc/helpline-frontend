...
class AppConfig @Inject()(config: Configuration, servicesConfig: ServicesConfig) {
  ...
  val helplinesByServiceListMapper = List(
    ...
    "Bingo Duty",
    "Biodiesel and Fuels Production Duty",
    "Capital Gains Tax",
    "Change VAT registration details",
    "Charities and Community Amateur Sports Clubs",
    "Child Trust Fund",
    "Claims for Refund of VAT by Certain Bodies",
    "Construction Industry Scheme (CIS)",
    "Corporation Tax",
    "Country by country reporting",
    "Cross-border arrangement",
    "Customs Declaration Service",
    "Customs Trader Services (CTS)",
    ...
    "Non-taxable trust registration",
    "Notification of Vehicle Arrivals (NOVA)",
    "Other business taxes, duties and schemes",
    "PAYE for employers",
    ...
    "Report & Pay Import VAT (NI)",
    "Report & Pay Import VAT (TSP)",
    "Safety and security",
    "Self Assessment",
    ...
    "Stamp Duty Land Tax for Organisations",
    ...
    "VAT Mini One Stop Shop - for businesses based in the UK and EU",
    "VAT Mini One Stop Shop - for businesses based outside the UK and EU",
    "VAT Reverse Charge Sales List (RCSL)",
    "VOA check and challenge your business rates valuation"
  )
  ...
  val helplinesByServiceList: List[String] = helplinesByServiceListMapper
